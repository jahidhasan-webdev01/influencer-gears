...
const Navbar = () => {
    ...
    return (
        <div className="bg-base-100 shadow-sm pt-10">
            <div className='navbar w-full pr-5 md:w-10/12 md:px-0 mx-auto'>
                    ...
                    <div className="flex items-center gap-5 text-base font-medium">
                        ...
                        <div className="relative">
                            <NavLink to="/cart" className="nav-link">
                                ...
                                {cart.length > 0 && (
                                    <span className='absolute -top-3 -right-2 text-xs bg-purple-500 px-1 rounded-full flex items-center justify-center text-white'>
                                        {cart.length}
                                    </span>
                                )}
                            </NavLink>
